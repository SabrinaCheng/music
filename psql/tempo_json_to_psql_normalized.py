...
needed_cols = ['metadata/song_id', 'metadata/title', 'metadata/artist_name', 'metadata/song_hotttnesss', 'analysis/duration', 'analysis/tempo']
        ...
        for f in files:
            ...
            with open(f) as json_file:
                ...
                for h5_name, row in songs.items():
                    ...
                    needed_data.append(tuple([row[ncol] if row[ncol] else None for ncol in needed_cols]))
                ...
                try:
                    ...
                    # insert to needed
                    execute_values(cur,
                            'INSERT INTO needed (song_id, title, artist_name, song_hotness, duration, tempo) VALUES %s', needed_data)
